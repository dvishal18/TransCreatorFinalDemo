...
import static com.datasyn.transcreator.R.id.text;
...
public class GoogleTranslate {
    ...
    public static void main(String[] args) {
        ...
        GoogleTranslate translator = new GoogleTranslate("your API Key");    //change it to your own apikey generated by google
